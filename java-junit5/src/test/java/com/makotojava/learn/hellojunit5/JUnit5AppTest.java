 ...
 * <li>Give the class a cool {@link DisplayName @DisplayName} that shows up in the JUnit test
 * report.</li>
 * </ol>
 *
 */
public class JUnit5AppTest {
  ...
  class PositiveAndNegativeNumbersTest {
     ...
     * <li>Pass the following numbers as operands to the {@link App#add(long[]) add}
     * method: 1, 2, 3, 4, 5</li>
  ...
  class JUnit5AppZeroOperandsTest {
     ...
     * <li>Give it a cool display name for the test report.</li>
     * <li>The reference to the class under test cannot be null. If it is, the test should fail.</li>
     * <li>Pass an empty array as operands argument to the {@link App#add(long[]) add}
     * method.</li>
     * <li>Ensure that an {@link IllegalArgumentException IllegalArgumentException} is thrown (hint: use the
